                ...
                <div class="col-10">
                  ...
                  <form action="/intern/{{ $intern->id }}" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control bg-body-tertiary bg-secondary-subtle" name="intern_name" value="{{ $intern->intern_name }}" placeholder="{{ $intern->intern_name }}">
                  </div>

                  <div class="mb-3">
                    <label for="name" class="form-label fs-4">Email</label>
                    <input type="text" class="form-control bg-body-tertiary bg-secondary-subtle" name="email" value="{{ $intern->email }}" placeholder="{{ $intern->email }}">
                </div>

                <div class="mb-3">
                  <label for="name" class="form-label fs-4">Phone_number</label>
                  <input type="text" class="form-control bg-body-tertiary bg-secondary-subtle" name="phone_number" value="{{ $intern->phone_number }}" placeholder="{{ $intern->phone_number }}">
              </div>

              <div class="mb-3">
                <label for="name" class="form-label fs-4">Home Address</label>
                <input type="text" class="form-control bg-body-tertiary bg-secondary-subtle" name="home_address" value="{{ $intern->home_address }}" placeholder="{{ $intern->home_address }}">
            </div>

            <div class="mb-3">
              <label for="name" class="form-label fs-4">Class</label>
              <input type="text" class="form-control bg-body-tertiary bg-secondary-subtle" name="class" value="{{ $intern->class }}" placeholder="{{ $intern->class}}">
          </div>
