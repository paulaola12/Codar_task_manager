    ...
    <div class="body-wrapper">
      ...
      {{-- content start --}}
        <div style="margin-top: 100px"  class="container mt-5">
            ...
            <h2 class="text-center mb-4">Task Update</h2>
                ...
                <div class="col-10">
                  <form action="/tasks/{{ $tasks->id }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-body-tertiary bg-secondary-subtle" name="task_name" placeholder="{{ $tasks->task_name }}">
                    </div>
                    ...
                    <div class="mb-3">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control  bg-secondary-subtle" name="start_date" placeholder="{{ $tasks->start_date }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="endDate" class="form-label fs-4">End Date</label>
                                    <input type="date" class="form-control  bg-secondary-subtle" name="end_date" placeholder="{{ $tasks->end_date }}">
                                </div>
                            </div>  
                    </div>
