...
<body>
    ...
    <div class="content">
        ...
        <div class="form-container">
            <h4 class="mb-4">Update Task Form</h4>
            <form action="/tasks/{{ $tasks->id }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="taskName" class="form-label">Task</label>
                    <input type="text" class="form-control" id="taskName"  name="task_name" value="{{ $tasks->task_name }}" placeholder="{{ $tasks->task_name }}">
                </div>
              ...
              $('#project_details').html('');
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="startDate" name="start_date" value="{{ $tasks->start_date }}" placeholder="{{ $tasks->start_date }}">
                    </div>
                    <div class="col-md-6">
                        <label for="endDate" class="form-label">End Date</label>
                        <input type="date" class="form-control" name="end_date" value="{{ $tasks->end_date }}" placeholder="{{ $tasks->end_date }}">
                    </div>
                </div>

                <div class="mb-3">
                    {{-- <label for="taskName" class="form-label">Status</label> --}}
                    <input type="text" class="form-control" id="taskName" name="status" placeholder="Enter New Task" value="{{ $tasks->status }}" hidden>
                </div>
