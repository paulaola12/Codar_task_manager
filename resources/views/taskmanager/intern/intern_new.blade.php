        ...
        <div class="form-container">
            ...
            <form action="{{ route('create_intern') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="projectName" name="intern_name" placeholder="Enter Intern name">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="projectName"  name="home_address" placeholder="Enter Home Address">
                </div>

                <div class="mb-4">
                    <label for="projectName" class="form-label">Class</label>
                    <input type="text" class="form-control" id="projectName"  name="class" placeholder="Enter Class">
                </div>
